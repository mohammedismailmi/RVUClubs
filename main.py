...
#
#         self.add_button = tk.Button(self, text="Add Club", command=self.add_club)
#         self.add_button.pack(side=tk.LEFT, padx=10, pady=10)
#
#         self.update_button = tk.Button(self, text="Update Club", command=self.update_club)
...
#
#     def add_club(self):
#         # Add your dialog for adding club here
#         pass
#
#     def update_club(self):
#         # Add your dialog for updating club here
#         pass
#
#     def delete_club(self):
#         selected_item = self.tree.selection()[0]
#         club_id = self.tree.item(selected_item)['values'][0]
#         delete_club(club_id)
#         self.load_clubs()
#
#
